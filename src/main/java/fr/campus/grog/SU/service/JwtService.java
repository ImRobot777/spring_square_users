...
public class JwtService {
    ...
    public void init() throws Exception {
        ...
        String privateKeyContent = new String(this.privateKeyResource.getInputStream().readAllBytes(), StandardCharsets.UTF_8);
        // Strip the PEM header/footer lines and all whitespace (newlines/spaces).
        // Java's Base64 decoder strictly expects pure Base64 characters and would fail on line breaks.
        ...
        // PKCS#8 is the standard international format for private keys generated by OpenSSL.
        // Convert the binary specification into a concrete java.security.PrivateKey instance.
